...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeActionFromQValues(self, state):
        ...
        for action in legalActions:
            ...
            if value > 0.0:
                allNegative = allNegative and False

        if allNegative and chosenQValue == 0.0:
            chosenAction = random.choice(unseenActions)
